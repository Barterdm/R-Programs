...
apikey <- "aCKfnjFKfKADVHXguUqPzSnIg"
apiskey <- 'MyHJcsHtY6Nb8qObXMo5JOIBTRwjg3Jt8zO5qTY27RgNRLbyJn'
acckey <- '965299195-6ted0mZZiQciEiju68d4OMCyMRs7dqSs1TYEpfDM'
accskey <- 'Sxd7WW6ttYXMfbpiERUajD5wMHqcW5uQyAVl5Ob1TfPjY'

setup_twitter_oauth(apikey,apiskey,acckey,accskey)

df_tweets <- twListToDF(searchTwitter('SmackDown OR #SDLive', n = 1000, lang = 'en')) %>%
